...
function render(){
  ...
  cards.innerHTML=shown.map((b,i)=>`<article class="bank-card"><span class="rank ${i<3?`rank-${i+1}`:""}">№${i+1}</span><div class="bank-info"><img class="bank-logo" src="assets/bank-logos/${b.icon}" alt="${b.name} app logo"><div class="bank-text"><span class="bank-name">${b.name}</span><span class="bank-legal">${b.legal}</span><span class="bank-tags">${b.tags}</span></div></div><div class="bank-right"><div class="stats-row"><div class="stat"><span class="stat-label">Customer Score</span><span class="stat-value">${b.score}</span></div><span class="stat-divider" aria-hidden="true"></span><div class="stat"><span class="stat-label">Branches</span><span class="stat-value">${b.branches}</span></div><span class="stat-divider" aria-hidden="true"></span><div class="stat"><span class="stat-label">Founded</span><span class="stat-value">${b.founded}</span></div></div><a class="rate-btn" href="${b.href}">View Bank<svg viewBox="0 0 14 14" aria-hidden="true"><line x1="1" y1="13" x2="13" y2="1"/><polyline points="5 1 13 1 13 9"/></svg></a></div></article>`).join("");
