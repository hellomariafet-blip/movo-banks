(() => {
  ...
  function renderFooter() {
    document.body.classList.add('movo-has-site-footer');
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.textContent = `
        ...
        body.movo-has-site-footer {
          min-height: 100vh;
          display: flex;
          flex-direction: column;
        }

        body.movo-has-site-footer > main {
          flex: 1 0 auto;
        }

        body.movo-has-site-footer > .movo-footer,
        body.movo-has-site-footer > .movo-legal-disclaimer {
          flex-shrink: 0;
        }

        body.movo-has-site-footer:not(:has(> main)) > .movo-footer {
          margin-top: auto;
        }
    ...
    const legalDisclaimer = document.querySelector('.movo-legal-disclaimer');
    if (legalDisclaimer) {
      legalDisclaimer.before(footer);
    } else {
